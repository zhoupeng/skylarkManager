...
#  137951-dump-all-the-attributes-of-an-object/
# -------------------------------------------------------------------

"""Dump all the attributes of an object (Python recipe)
Print a nicely formatted overview of an object.

You can hand dumpObj any data type -- a module, class, instance, new class.

The output lines will be wrapped at maxlen,
with lindent of space for names of attributes.
A maximum of maxspew characters will be printed for each attribute value. 
Note that in reformatting for compactness the routine
trashes any formatting in the docstrings it prints.
"""
